...
typedef struct {
  __IO CR_bits          CR;            /*!< RCC clock control register, Reference Manual 6.3                                  Address offset: 0x00 */
  ...
  __IO AHB1ENR_bits     AHB3ENR;       /*!< RCC AHB3 peripheral clock register,                          Address offset: 0x38 */
